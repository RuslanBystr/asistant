...
__all__ = [
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SAFTCCITT_uLaw_22kHzStereo',
    'ISpShortcut', 'DISPID_SRCState', 'DISPID_SDKOpenKey',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SVEventInterests',
    'SVP_11', 'SAFT11kHz8BitMono', 'SpMemoryStream',
    'ISpeechObjectTokens', 'SVP_15', 'SpeechPropertyResponseSpeed',
    'DISPID_SGRsDynamic', 'SAFTGSM610_22kHzMono',
    'DISPID_SpeechPhraseReplacements', 'SPRS_ACTIVE',
    'SECLowConfidence', 'DISPID_SRGetFormat', 'eWORDTYPE_DELETED',
    'ISpNotifySink', 'eLEXTYPE_RESERVED8', 'ISpeechRecoResult',
    'DISPID_SVAudioOutputStream', 'ISpPhoneticAlphabetConverter',
    'DISPID_SpeechLexicon', 'SGDisplay', 'SRARoot',
    'STCInprocHandler', 'SPEI_TTS_PRIVATE', 'DISPID_SOTCGetDataKey',
    'SAFT32kHz16BitMono', 'DISPID_SpeechMemoryStream',
    'DISPID_SpeechRecoResultTimes', 'ISpeechPhraseElements',
    'DISPID_SLWType', 'eLEXTYPE_VENDORLEXICON', 'DISPID_SMSAMMHandle',
    'ISpRecognizer2', 'SPINTERFERENCE', 'DISPID_SFSClose',
    'SPINTERFERENCE_NOISE', 'SPSERIALIZEDPHRASE', 'SPCT_SUB_COMMAND',
    'DISPID_SPPFirstElement', 'SVSFParseSsml',
    'DISPID_SRRDiscardResultInfo', 'SpeechVoiceSkipTypeSentence',
    'SpObjectTokenCategory', 'DISPID_SVSLastBookmark',
    'DISPID_SPEs_NewEnum', 'SPEI_VISEME', 'DISPID_SRGRules',
    'DISPID_SpeechRecoContext', 'SPSNotOverriden',
    'DISPID_SRCERequestUI', 'SPCATEGORYTYPE', 'SpNullPhoneConverter',
    'DISPID_SPCLangId', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SPCPhoneToId', 'eLEXTYPE_RESERVED10',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'ISpNotifySource',
    'SpeechRetainedAudioOptions', 'SPXMLRESULTOPTIONS', 'tagSTATSTG',
    'SPAUDIOSTATE', 'DISPID_SGRSTsItem', 'SpVoice',
    'DISPID_SABufferNotifySize', 'ISpObjectTokenCategory',
    'DISPID_SLPs_NewEnum', 'SRERecognition',
    'DISPID_SASFreeBufferSpace', 'DISPID_SRCEBookmark',
    'SVESentenceBoundary', 'DISPID_SpeechVoice', 'DISPID_SVEBookmark',
    'ISpeechPhraseReplacements', 'DISPID_SVEWord',
    'SpStreamFormatConverter', 'SREPhraseStart', 'SAFT24kHz8BitMono',
    'SAFTCCITT_uLaw_8kHzMono', 'ISpeechPhoneConverter',
    'DISPID_SPERequiredConfidence', 'SDKLLocalMachine',
    'SpeechCategoryRecoProfiles', 'DISPID_SDKSetStringValue',
    'DISPID_SVStatus', 'SAFTADPCM_8kHzMono', 'SREAudioLevel',
    'DISPID_SAEventHandle', 'SAFT8kHz16BitStereo',
    'DISPID_SRCEPhraseStart', 'ISpeechGrammarRuleState',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SOTCId',
    'SRTSMLTimeout', 'SP_VISEME_3', 'SPPS_Unknown',
    'DISPID_SVEStreamStart', 'DISPID_SGRSTRule',
    'SpeechDataKeyLocation', 'SGRSTTEpsilon', 'SINoSignal',
    'DISPID_SRIsUISupported', 'SVP_12', 'SPDATAKEYLOCATION',
    'SAFT44kHz16BitStereo', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SWFEFormatTag', 'DISPID_SOTsItem', 'DISPID_SGRSTsCount',
    'DISPID_SRCRecognizer', 'SPEI_RESERVED1', 'SPAR_Medium',
    'SWTAdded', 'DISPID_SBSWrite', 'SpeechInterference', 'SLTApp',
    'DISPID_SRStatus', 'DISPID_SAFType', 'DISPID_SGRInitialState',
    'ISpeechFileStream', 'SPDKL_LocalMachine',
    'DISPID_SRCSetAdaptationData', 'ISpSerializeState',
    'ISpRecognizer', 'DISPID_SRGCmdLoadFromResource',
    'SAFTADPCM_44kHzStereo', 'IInternetSecurityManager',
    'DISPID_SpeechDataKey', 'SpeechAudioState',
    'DISPID_SpeechVoiceStatus', 'SpeechBookmarkOptions',
    'SPSMF_SAPI_PROPERTIES', 'Speech_StreamPos_Asap',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SPAStartElementInResult',
    'SPINTERFERENCE_TOOQUIET', 'SVP_1', 'DISPID_SOTIsUISupported',
    'DISPID_SVDisplayUI', 'SWPKnownWordPronounceable',
    'DISPID_SRCResume', 'DISPID_SWFEChannels', 'SVSFParseAutodetect',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPAPhraseInfo', 'DISPID_SVRate',
    'DISPID_SRAudioInput', 'SP_VISEME_1', 'SSFMCreateForWrite',
    'DISPID_SVEVoiceChange', 'DISPID_SpeechPhraseRule',
    'DISPID_SDKDeleteValue', 'SRTStandard', 'SPPHRASEPROPERTY',
    'SpeechTokenShellFolder', 'DISPID_SABIMinNotification',
    'SBOPause', 'DISPID_SRGRecoContext',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPAS_PAUSE',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SVResume',
    'ISpeechPhraseElement', 'SVP_14', 'SPFM_OPEN_READONLY',
    'DISPID_SMSALineId', 'SDKLCurrentConfig', 'eLEXTYPE_APP',
    'SpeechStreamFileMode', 'UINT_PTR',
    'ISpeechTextSelectionInformation', 'SAFTGSM610_44kHzMono',
    'DISPID_SVSpeakStream', 'DISPID_SPRNumberOfElements',
    'SREFalseRecognition', 'SGSEnabled', 'SVP_4',
    'DISPID_SRCEStartStream', 'DISPID_SRCEPropertyStringChange',
    'SLTUser', 'DISPID_SPIAudioSizeTime', 'DISPID_SVWaitUntilDone',
    'ISpeechRecoResultDispatch', 'SPPS_RESERVED1', 'SpeechLoadOption',
    'DISPID_SpeechRecognizerStatus', 'SPFM_OPEN_READWRITE',
    'SPGS_DISABLED', 'eLEXTYPE_PRIVATE1', 'SASPause',
    'SECFIgnoreCase', 'SGDSInactive', 'SAFTNonStandardFormat',
    'eLEXTYPE_PRIVATE6', 'SRADynamic', 'DISPID_SVEStreamEnd',
    'DISPIDSPTSI_SelectionOffset', 'SVEWordBoundary',
    'SPRST_INACTIVE_WITH_PURGE', 'SPSEMANTICFORMAT', 'SVP_5',
    'SpeechDisplayAttributes', 'SPSHORTCUTTYPE',
    'DISPID_SRCRetainedAudio', 'DISPID_SRRSetTextFeedback',
    'SAFT24kHz8BitStereo', 'ISpMMSysAudio',
    'ISpStreamFormatConverter', 'ISpeechGrammarRules',
    'eLEXTYPE_MORPHOLOGY', 'SREPropertyStringChange',
    'SAFTADPCM_22kHzStereo', 'SpeechGrammarTagWildcard',
    'DISPID_SLPType', 'DISPID_SVGetProfiles',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SpeechObjectTokenCategory',
    'SPVISEMES', 'SDTReplacement', 'DISPID_SpeechGrammarRuleState',
    'SPVPRI_ALERT', 'SVP_0', 'DISPID_SVGetVoices',
    'DISPID_SRGDictationLoad', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SPSEMANTICERRORINFO', 'SSSPTRelativeToStart',
    'SAFT12kHz16BitMono', 'eLEXTYPE_PRIVATE19',
    'DISPID_SpeechMMSysAudio', 'DISPID_SDKDeleteKey',
    'DISPID_SVEEnginePrivate', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SDKGetStringValue', 'DISPID_SPIReplacements',
    'DISPID_SLWsItem', 'SPSTREAMFORMATTYPE', 'SAFT8kHz16BitMono',
    'DISPID_SRCBookmark', 'SPSInterjection', 'SPEI_MAX_TTS',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPADAPTATIONRELEVANCE', 'SpeechTokenKeyAttributes',
    'SpeechRuleAttributes', 'DISPID_SBSRead', 'SVEVoiceChange',
    'DISPID_SPELexicalForm', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SpeechPhraseProperty', 'DISPID_SMSSetData', 'SPAR_High',
    'DISPID_SpeechVoiceEvent', 'DISPID_SRSNumberOfActiveRules',
    'SRAONone', 'SPFM_CREATE', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SPPParent', 'SpeechGrammarTagUnlimitedDictation',
    'SDKLCurrentUser', 'SPWF_INPUT', 'DISPID_SAFGetWaveFormatEx',
    'SVEPrivate', 'DISPID_SpeechRecoContextEvents', 'SpeechWordType',
    'SPCT_COMMAND', 'SpeechVoiceCategoryTTSRate', 'SPAUDIOOPTIONS',
    'SpeechVoicePriority', 'DISPID_SRCEEnginePrivate', 'ISpAudio',
    'DISPID_SPIProperties', 'SAFT44kHz8BitMono', 'SPSNoun',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SVEViseme',
    'SGRSTTWord', 'SVSFlagsAsync', 'SPAS_RUN',
    'ISpeechLexiconPronunciations', 'DISPID_SPRuleChildren',
    'eWORDTYPE_ADDED', 'SRCS_Disabled', 'SP_VISEME_15',
    'SPRECOCONTEXTSTATUS', 'ISpeechAudioFormat',
    'DISPID_SRGetRecognizers', 'SAFTCCITT_ALaw_44kHzStereo',
    'SPSHORTCUTPAIRLIST', 'SAFT12kHz8BitMono', 'SAFT11kHz16BitMono',
    'SVSFUnusedFlags', 'ISpeechPhraseReplacement',
    'SAFTCCITT_ALaw_8kHzMono', 'ISpXMLRecoResult', 'DISPID_SGRsCount',
    'DISPID_SRRAudioFormat', 'ISpPhraseAlt', 'SPRULE',
    'DISPID_SpeechObjectTokens', 'DISPID_SPIAudioSizeBytes', 'SPWORD',
    'SAFT11kHz16BitStereo', 'DISPID_SLPSymbolic', 'SVEAllEvents',
    'DISPID_SRCCmdMaxAlternates', 'ISpeechPhraseRules',
    'SGRSTTWildcard', 'SPPS_Interjection', 'SINone',
    'DISPID_SPACommit', 'DISPID_SAFGuid', 'SP_VISEME_14',
    'SPEI_SR_PRIVATE', 'DISPID_SOTGetStorageFileName', 'SPSLMA',
    'SPINTERFERENCE_LATENCY_WARNING', 'SDTAlternates', 'SPEVENT',
    'IEnumString', 'SpObjectToken', 'SpeechCategoryVoices',
    'DISPID_SPRuleConfidence', 'STSF_AppData', 'SGRSTTTextBuffer',
    'SPCS_ENABLED', 'SVP_7', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SPRuleName', 'SREPropertyNumChange',
    'SAFT48kHz8BitStereo', 'SPCONTEXTSTATE',
    'SPEI_START_INPUT_STREAM', 'DISPID_SOTDisplayUI', 'SP_VISEME_10',
    'DISPID_SRCVoice', 'ISpeechPhraseRule', 'ISpeechVoiceStatus',
    'SPWORDLIST', 'DISPID_SRGCmdSetRuleState',
    'SDA_Two_Trailing_Spaces', 'SECFIgnoreKanaType',
    'SPEI_SR_RETAINEDAUDIO', 'SPRECOSTATE',
    'DISPID_SpeechPhraseReplacement', 'SPVPRI_NORMAL',
    'SAFTCCITT_uLaw_44kHzStereo', 'SRAImport', 'SWTDeleted',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SPRText',
    'SVSFIsFilename', 'SGDSActive', 'ISpObjectWithToken',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SPEPronunciation',
    'SpMMAudioIn', 'SPGRAMMARSTATE', 'ISpStreamFormat', 'SSFMCreate',
    'SPAUDIOSTATUS', 'SITooQuiet', 'DISPID_SGRSTransitions',
    'ISpRecognizer3', 'SPSHT_OTHER', 'SPFM_CREATE_ALWAYS',
    'SLODynamic', 'DISPID_SOTGetAttribute', 'DISPID_SRRecognizer',
    'DISPID_SpeechRecognizer', 'DISPID_SOTCSetId',
    'DISPID_SGRSTPropertyValue', 'DISPID_SGRSAddWordTransition',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SGRAttributes',
    'ISpeechWaveFormatEx', 'DISPID_SPRuleEngineConfidence',
    'SPGRAMMARWORDTYPE', 'SVPNormal', 'SAFTCCITT_ALaw_8kHzStereo',
    'SRSInactiveWithPurge', 'ISpeechPhraseProperty',
    'DISPID_SVSInputWordLength', 'DISPID_SRCEInterference',
    'SpResourceManager', 'SpeechPropertyNormalConfidenceThreshold',
    'SpNotifyTranslator', 'eLEXTYPE_PRIVATE8',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SRCESoundStart', 'ISpeechGrammarRuleStateTransitions',
    'SpeechCategoryAppLexicons', 'DISPID_SOTRemove',
    'DISPIDSPTSI_SelectionLength', 'ISpeechLexiconWords',
    '_SPAUDIOSTATE', 'STSF_CommonAppData', 'DISPID_SRRGetXMLResult',
    'SPWT_PRONUNCIATION', 'DISPID_SRSetPropertyNumber', 'SLOStatic',
    'DISPID_SOTDataKey', 'DISPID_SWFESamplesPerSec',
    'DISPID_SPRDisplayAttributes', 'DISPID_SPPConfidence',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SVAudioOutput', 'SASRun',
    'SPBO_NONE', 'DISPID_SPIStartTime', 'SPVPRIORITY', 'SpStream',
    'eLEXTYPE_USER', 'SpeechPropertyResourceUsage',
    'SAFTNoAssignedFormat', 'SpeechRecoProfileProperties',
    'SPWORDPRONUNCIATIONLIST', 'SpeechEmulationCompareFlags',
    'ISpeechVoice', 'SRTEmulated', 'SSFMOpenForRead', 'SP_VISEME_2',
    'SAFTTrueSpeech_8kHz1BitMono', 'ISpeechAudioBufferInfo',
    'SPRULESTATE', 'SpeechTokenKeyUI', 'SVPAlert', 'DISPID_SBSFormat',
    'SPPS_NotOverriden', 'SPAR_Low', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SpeechWaveFormatEx', 'SRSInactive', 'SREAllEvents',
    'SPWF_SRENGINE', 'SpeechVisemeType', 'DISPID_SWFEAvgBytesPerSec',
    'eLEXTYPE_PRIVATE17', 'SDA_Consume_Leading_Spaces',
    'SpeechAddRemoveWord', 'ISpeechMemoryStream', 'SPEI_ADAPTATION',
    'SPXRO_SML', 'eLEXTYPE_USER_SHORTCUT', 'STCRemoteServer',
    'SpeechTokenContext', 'DISPID_SRGDictationSetState',
    'DISPID_SPAs_NewEnum', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SPVOICESTATUS', 'SPBOOKMARKOPTIONS', 'SRTExtendableParse',
    'SVP_17', 'DISPID_SPILanguageId', 'STSF_LocalAppData',
    '_ISpeechVoiceEvents', 'eLEXTYPE_RESERVED7', 'SDTDisplayText',
    'DISPID_SLGetGenerationChange', 'SpSharedRecoContext',
    'SpPhoneConverter', 'SPSHT_EMAIL', 'SGSDisabled',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SABufferInfo',
    'DISPID_SPAsCount', 'SpInprocRecognizer', 'DISPID_SPRulesCount',
    'SPPS_Noncontent', 'SPSModifier', 'SRTAutopause',
    'DISPID_SPCIdToPhone', 'SPAS_STOP', 'SpeechLexiconType',
    'SPCS_DISABLED', 'SDKLDefaultLocation', 'DISPID_SABIEventBias',
    'DISPID_SRCESoundEnd', 'DISPID_SPEEngineConfidence',
    'DISPID_SGRSRule', 'ISpeechResourceLoader',
    'DISPID_SpeechAudioBufferInfo', 'SAFTCCITT_uLaw_22kHzMono',
    'SpeechRegistryLocalMachineRoot', 'ISpObjectToken',
    'DISPID_SpeechAudioStatus', 'eLEXTYPE_RESERVED6',
    'DISPID_SRState', 'SPEI_PHONEME', 'SpTextSelectionInformation',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPFM_NUM_MODES',
    'SPEI_RECO_OTHER_CONTEXT', 'SPEI_RECO_STATE_CHANGE', 'SDTRule',
    'DISPID_SREmulateRecognition', 'DISPID_SPPName',
    'DISPID_SRRTTickCount', 'DISPID_SRSCurrentStreamPosition',
    'SpeechPropertyLowConfidenceThreshold', 'ISpGrammarBuilder',
    'DISPID_SRCCreateGrammar', 'SSTTTextBuffer', 'SPEI_PHRASE_START',
    'ISpeechAudioStatus', 'DISPID_SPRuleId', 'SPEI_SENTENCE_BOUNDARY',
    'SRSActive', 'DISPID_SRCEventInterests',
    'DISPID_SpeechPhraseProperties', 'DISPID_SOTsCount',
    'STCLocalServer', 'SITooLoud', 'DISPID_SPRs_NewEnum',
    'SAFTExtendedAudioFormat', 'DISPID_SABIBufferSize',
    'DISPIDSPTSI_ActiveLength', 'SAFT32kHz8BitStereo',
    'SPPS_RESERVED3', 'SpWaveFormatEx', 'DISPID_SGRId',
    'DISPID_SASetState', 'DISPID_SLRemovePronunciation',
    'DISPID_SRCERecognitionForOtherContext', 'SPWORDPRONUNCIATION',
    'SPSHORTCUTPAIR', 'SDA_One_Trailing_Space',
    'DISPID_SRAudioInputStream', 'SpUnCompressedLexicon',
    'SREAdaptation', 'WAVEFORMATEX', 'SVP_16',
    'SpeechEngineConfidence', 'SRESoundEnd', 'SPEI_WORD_BOUNDARY',
    'DISPID_SLAddPronunciation', 'SDTAll',
    'DISPID_SPANumberOfElementsInResult', 'SPPS_Noun',
    'DISPID_SpeechObjectToken', 'SPCT_SUB_DICTATION', 'SPBO_PAUSE',
    'SPSERIALIZEDRESULT', 'SPEI_VOICE_CHANGE', 'ISpeechBaseStream',
    'SPSFunction', 'ISpeechGrammarRule', 'ISpeechCustomStream',
    'DISPID_SpeechAudio', 'DISPID_SPPValue', 'SPBINARYGRAMMAR',
    'SpCustomStream', 'DISPID_SADefaultFormat',
    'DISPID_SVIsUISupported', 'SpeechStreamSeekPositionType',
    'DISPID_SVEAudioLevel', 'eLEXTYPE_PRIVATE14',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPAS_CLOSED', 'SDTAudio',
    'DISPID_SCSBaseStream', 'DISPID_SpeechCustomStream',
    'DISPID_SRGSetTextSelection', 'SINoise', 'DISPID_SRRAudio',
    'SpeechGrammarRuleStateTransitionType', 'ISpeechRecognizer',
    'SRAInterpreter', 'DISPID_SRGState', 'DISPID_SDKGetlongValue',
    'DISPID_SFSOpen', 'SPEI_RESERVED3', 'DISPID_SLWs_NewEnum',
    'DISPID_SLPLangId', 'DISPID_SPPs_NewEnum', 'DISPID_SAVolume',
    '_ISpeechRecoContextEvents',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPAO_RETAIN_AUDIO',
    'SPAR_Unknown', 'SpeechRecognizerState', 'DISPID_SOTs_NewEnum',
    'LONG_PTR', 'SpeechPartOfSpeech', 'DISPID_SRGCmdLoadFromFile',
    'SpInProcRecoContext', 'SPEI_RESERVED6', 'DISPID_SVSkip',
    'DISPID_SLGetPronunciations', 'ISequentialStream',
    'DISPID_SRGDictationUnload', 'DISPID_SPRFirstElement',
    'DISPID_SGRsCommit', 'DISPID_SGRsItem', 'SPINTERFERENCE_TOOLOUD',
    'SPPHRASEREPLACEMENT', 'SPDKL_DefaultLocation',
    'DISPID_SPIRetainedSizeBytes', 'SWPUnknownWordUnpronounceable',
    'ISpeechRecognizerStatus', 'ISpRecoResult', '_RemotableHandle',
    'SpeechSpecialTransitionType', 'SDTLexicalForm',
    'SpeechVoiceSpeakFlags', 'DISPID_SGRSTPropertyId',
    'SpPhraseInfoBuilder', 'SpeechGrammarTagDictation',
    'SpeechAudioFormatGUIDText', 'SITooSlow', 'SRSActiveAlways',
    'ISpeechDataKey', 'ISpeechRecoGrammar', 'SPEI_TTS_BOOKMARK',
    'DISPID_SVSLastResult', 'DISPID_SRProfile', 'SVSFIsNotXML',
    'SECFDefault', 'SPINTERFERENCE_TOOFAST', 'DISPID_SRCEHypothesis',
    'SVSFParseMask', 'DISPID_SPISaveToMemory', 'ISpeechObjectToken',
    'SVPOver', 'SDTProperty', 'DISPID_SVSPhonemeId',
    'SpeechMicTraining', 'SP_VISEME_20', 'SAFT16kHz16BitStereo',
    'DISPID_SRRTStreamTime', 'SVSFIsXML', 'SP_VISEME_8',
    'SPCT_DICTATION', 'SpeechCategoryAudioIn', 'SPEI_SR_BOOKMARK',
    'DISPID_SPIElements', 'SAFTADPCM_44kHzMono',
    'DISPID_SGRsCommitAndSave', 'SPEI_PROPERTY_STRING_CHANGE',
    'SPEI_START_SR_STREAM', 'SpeechFormatType', 'DISPID_SLPsCount',
    'IInternetSecurityMgrSite', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SVSInputWordPosition', 'DISPID_SPIGrammarId',
    'SPRS_INACTIVE', 'SECHighConfidence',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'ISpRecoCategory',
    'DISPID_SGRs_NewEnum', 'SPXRO_Alternates_SML',
    'SAFT32kHz8BitMono', 'SPEI_END_SR_STREAM', 'DISPID_SLGetWords',
    'SPEI_INTERFERENCE', 'DISPID_SVAlertBoundary',
    'DISPID_SRCERecognizerStateChange', 'SAFT32kHz16BitStereo',
    'ISpDataKey', 'ISpPhoneConverter', 'SPGS_EXCLUSIVE',
    'eLEXTYPE_PRIVATE4', 'SpMMAudioOut', 'DISPID_SRCEEndStream',
    'SpeechAudioVolume', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SMSGetData', 'SGLexical', 'DISPID_SPEsCount',
    'SP_VISEME_5', 'eLEXTYPE_PRIVATE15', 'SPLOADOPTIONS',
    'SpeechCategoryAudioOut', 'SAFT16kHz16BitMono',
    'DISPID_SRSSupportedLanguages', 'DISPID_SPEAudioSizeBytes',
    'ISpRecoGrammar', 'DISPID_SPEDisplayAttributes',
    'SECFEmulateResult', 'SPPARTOFSPEECH', 'SVP_8',
    'SAFT44kHz8BitStereo', 'SVP_19', 'DISPID_SVSVisemeId',
    'DISPIDSPRG', 'ISpeechLexiconWord', 'DISPID_SRGId',
    'ISpEventSource', 'SPVPRI_OVER', 'SPDKL_CurrentConfig',
    'DISPID_SRRPhraseInfo', 'eLEXTYPE_PRIVATE20',
    'SPRS_ACTIVE_USER_DELIMITED', 'SRAExport', 'SP_VISEME_0',
    'SAFT12kHz16BitStereo', 'DISPID_SPARecoResult', 'SPLO_STATIC',
    'DISPID_SRSAudioStatus', 'SpMMAudioEnum', 'tagSPPROPERTYINFO',
    'DISPID_SDKEnumKeys', 'SPEI_END_INPUT_STREAM', 'SPRST_NUM_STATES',
    'SVEPhoneme', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SPPNumberOfElements', 'DISPID_SPEDisplayText',
    'DISPID_SVESentenceBoundary', '__MIDL_IWinTypes_0009',
    'DISPID_SpeechLexiconWord', 'DISPID_SRRTLength', 'SVSFPersistXML',
    'DISPID_SPPId', 'SAFTADPCM_11kHzMono', 'DISPID_SDKEnumValues',
    'DISPID_SVSyncronousSpeakTimeout', 'SPEI_HYPOTHESIS',
    'DISPID_SGRAddState', 'DISPID_SpeechGrammarRules',
    'SAFT16kHz8BitMono', 'DISPID_SWFEExtraData', 'SPEI_MIN_TTS',
    'ISpeechMMSysAudio', 'DISPID_SpeechGrammarRule',
    'DISPID_SRIsShared', 'SPEI_UNDEFINED', 'SGDSActiveUserDelimited',
    'SAFT24kHz16BitMono', 'ISpeechLexiconPronunciation',
    'DISPID_SRGCommit', 'eLEXTYPE_PRIVATE7', 'SAFTText',
    'DISPID_SDKCreateKey', 'DISPID_SPIRule',
    'DISPID_SDKSetBinaryValue', 'SPEVENTSOURCEINFO', 'DISPID_SGRName',
    'SAFT22kHz8BitStereo', 'DISPID_SRGIsPronounceable',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SGRAddResource',
    'SpeechUserTraining', 'SPBO_AHEAD', 'SpShortcut',
    'SAFTCCITT_ALaw_11kHzMono', 'SDTPronunciation', 'SVP_21',
    'SSTTDictation', 'DISPID_SDKSetLongValue', 'SVSFParseSapi',
    'ISpEventSink', 'eLEXTYPE_PRIVATE13', 'SVP_2',
    'DISPID_SRRTOffsetFromStart', 'SPPS_Verb', 'DISPID_SVPriority',
    'DISPID_SPRuleParent', 'SPPHRASERULE', 'eLEXTYPE_PRIVATE12',
    'SPEI_SOUND_START', 'DISPID_SRCreateRecoContext',
    'ISpeechObjectTokenCategory', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SRRSaveToMemory', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SLWWord', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'eLEXTYPE_PRIVATE16', 'DISPID_SAStatus', 'DISPID_SBSSeek',
    'SVEEndInputStream', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SPPsItem',
    'SPEI_RECOGNITION', 'DISPID_SOTId', 'SRESoundStart',
    'SP_VISEME_19', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SRCRetainedAudioFormat', 'SGLexicalNoSpecialChars',
    'DISPID_SRDisplayUI', 'DISPID_SLPsItem', 'DISPID_SASState',
    'ISpeechRecoContext', 'SAFTADPCM_11kHzStereo',
    'DISPIDSPTSI_ActiveOffset', 'SPPROPERTYINFO', 'STSF_FlagCreate',
    'SPEI_MAX_SR', 'SVSFNLPSpeakPunc', 'SpeechVisemeFeature',
    'SVF_None', 'SPLO_DYNAMIC', 'DISPID_SPAsItem',
    'SVEStartInputStream', 'SVEBookmark', 'SPSVerb',
    'ISpeechPhraseAlternates', 'DISPID_SpeechPhraseBuilder',
    'SpeechCategoryPhoneConverters', 'SPDKL_CurrentUser',
    'SpeechDiscardType', 'SPSHT_NotOverriden',
    'DISPID_SRCERecognition', 'SPWT_DISPLAY', 'SP_VISEME_12',
    'eLEXTYPE_PRIVATE11', 'STCInprocServer', 'DISPID_SLWsCount',
    'SP_VISEME_21', 'SFTInput', 'ISpeechPhraseProperties',
    'SPEI_RESERVED2', 'DISPID_SpeechBaseStream',
    'DISPID_SpeechPhraseElements', 'SpeechAllElements',
    'SVSFVoiceMask', 'SVP_20', 'SpeechRecoEvents', 'SPEI_SOUND_END',
    'SPEI_MIN_SR', 'SP_VISEME_7', 'DISPID_SASNonBlockingIO',
    'DISPID_SVSLastBookmarkId', 'eLEXTYPE_PRIVATE3', 'SPPS_Modifier',
    'DISPID_SRSClsidEngine', 'ISpPhrase', 'DISPID_SpeechPhraseRules',
    'SpeechWordPronounceable', 'SAFTCCITT_ALaw_44kHzMono',
    'eLEXTYPE_PRIVATE5', 'SpeechRuleState',
    'DISPID_SASCurrentSeekPosition', 'SAFTCCITT_ALaw_22kHzMono',
    'SAFT22kHz16BitMono', 'SRSEDone', 'DISPID_SGRsFindRule',
    'SAFT48kHz16BitMono', 'SPPS_SuppressWord', 'DISPID_SLWLangId',
    'DISPID_SRRTimes', 'SAFT48kHz16BitStereo',
    'DISPID_SLGenerationId', 'SPRECORESULTTIMES', 'DISPID_SVPause',
    'DISPID_SpeechLexiconPronunciation', 'SRERequestUI',
    'DISPID_SRRRecoContext', 'ISpStream', 'SP_VISEME_11',
    'DISPID_SRCEAdaptation', 'DISPID_SOTCDefault',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SPEsItem',
    'DISPID_SpeechPhraseElement', 'DISPID_SDKGetBinaryValue',
    'eLEXTYPE_LETTERTOSOUND', 'eLEXTYPE_RESERVED9', 'SPSHT_Unknown',
    'SP_VISEME_4', 'DISPID_SGRsAdd', 'DISPID_SGRSTNextState',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPBO_TIME_UNITS',
    'SPPS_LMA', 'DISPID_SpeechXMLRecoResult', 'ISpProperties',
    'Speech_Default_Weight', 'DISPID_SLPPartOfSpeech', 'SVF_Stressed',
    'tagSPTEXTSELECTIONINFO',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SpeechRegistryUserRoot', 'SVSFDefault', 'SPLEXICONTYPE',
    'SAFT24kHz16BitStereo', 'SPSUnknown', 'SGRSTTRule',
    'DISPID_SpeechRecoResult', 'SpeechDictationTopicSpelling',
    'SASStop', 'IEnumSpObjectTokens',
    'DISPID_SRCCreateResultFromMemory', 'SPSMF_UPS',
    'DISPID_SWFEBlockAlign', 'DISPID_SVSLastStreamNumberQueued',
    'SPEI_TTS_AUDIO_LEVEL', 'SpeechRunState', 'DISPID_SRRAlternates',
    'DISPID_SPIEngineId', 'SP_VISEME_13', 'DISPID_SPRulesItem',
    'DISPID_SpeechAudioFormat', 'SPINTERFERENCE_NONE',
    'DISPID_SPEAudioSizeTime', 'SPFILEMODE', 'SVP_9',
    'DISPID_SOTSetId', 'DISPID_SRCPause', 'IStream', 'SpLexicon',
    'SRCS_Enabled', 'SP_VISEME_17', 'SSFMOpenReadWrite',
    'DISPID_SGRSTText', 'ISpVoice', 'SP_VISEME_18', 'SP_VISEME_6',
    'SP_VISEME_9', 'SPWORDTYPE', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SWFEBitsPerSample', 'DISPID_SPPsCount',
    'SpeechRecognitionType', 'SAFT44kHz16BitMono',
    'SAFTGSM610_11kHzMono', 'SRAORetainAudio',
    'Speech_Max_Word_Length', 'SpeechTokenKeyFiles',
    'DISPID_SPRuleNumberOfElements', 'SAFTGSM610_8kHzMono',
    'SpSharedRecognizer', 'ISpRecoContext2',
    'DISPID_SOTCreateInstance', 'DISPID_SPRsCount',
    'Speech_Max_Pron_Length', 'SPWAVEFORMATTYPE', 'SPPS_Function',
    'SPEI_REQUEST_UI', 'SECFNoSpecialChars', 'SVP_10',
    'DISPID_SVSRunningState', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPINTERFERENCE_NOSIGNAL', 'SREInterference',
    'SPINTERFERENCE_TOOSLOW', 'ISpeechRecoResult2',
    'DISPID_SMSADeviceId', 'DISPID_SRRSpeakAudio',
    'DISPID_SPIEnginePrivateData', 'SpPhoneticAlphabetConverter',
    'SVEAudioLevel', 'SPPS_RESERVED2', 'DISPID_SVVoice',
    'DISPID_SOTRemoveStorageFileName', 'ISpeechPhraseInfoBuilder',
    'SITooFast', 'DISPID_SPEAudioTimeOffset', 'SPCT_SLEEP',
    'SPGS_ENABLED', 'SpeechGrammarWordType',
    'DISPID_SpeechLexiconWords', 'eLEXTYPE_PRIVATE2',
    'DISPID_SpeechFileStream', 'DISPID_SPIGetText',
    'SAFT8kHz8BitMono', 'eLEXTYPE_PRIVATE18', 'ISpNotifyTranslator',
    'SDA_No_Trailing_Space', 'DISPID_SVVolume', 'eLEXTYPE_PRIVATE9',
    'DISPID_SpeechRecoResult2', 'SPRST_INACTIVE',
    'ISpeechRecoResultTimes', 'SPWORDPRONOUNCEABLE',
    'SpeechTokenIdUserLexicon', 'ISpeechLexicon', 'SVP_13',
    'DISPID_SVSpeak', 'SP_VISEME_16', 'SAFT12kHz8BitStereo',
    'SPPHRASE', 'DISPID_SpeechPhraseInfo',
    'SpeechCategoryRecognizers', 'SPTEXTSELECTIONINFO',
    'DISPID_SRSetPropertyString',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SGSExclusive',
    'SpeechTokenValueCLSID', 'SpeechRecoContextState',
    'DISPID_SGRSTPropertyName', 'DISPID_SVSInputSentenceLength',
    'DISPID_SGRSTWeight', 'SECFIgnoreWidth', 'ISpResourceManager',
    'ISpeechPhraseAlternate', 'SRADefaultToActive', 'SVP_6',
    'SpeechPropertyAdaptationOn', 'DISPID_SPRuleFirstElement',
    'SSTTWildcard', 'SPPHRASEELEMENT', 'ISpRecoContext',
    'SRSEIsSpeaking', 'DISPID_SGRClear', 'DISPID_SRGReset',
    'DISPID_SPEAudioStreamOffset', 'SPEI_PROPERTY_NUM_CHANGE',
    'SRATopLevel', 'DISPID_SLPPhoneIds', 'SREPrivate',
    'SGPronounciation',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRGetPropertyString', 'SPPS_RESERVED4',
    'SAFT22kHz8BitMono', 'ISpeechAudio', 'DISPID_SGRSTType',
    'DISPID_SRCAudioInInterferenceStatus', 'SREStreamStart',
    'SRERecoOtherContext', 'SAFTCCITT_uLaw_11kHzMono', 'SVP_18',
    'SAFT48kHz8BitMono', 'ISpRecoGrammar2', 'SREStateChange',
    'SpeechAudioFormatGUIDWave', 'SPSSuppressWord',
    'SAFT11kHz8BitStereo', 'DISPID_SPRsItem', 'SpCompressedLexicon',
    'ISpLexicon', 'SpFileStream', 'STCAll', 'DISPID_SRCEAudioLevel',
    'SAFT16kHz8BitStereo', 'SpeechGrammarState', 'SPRST_ACTIVE',
    'SRTReSent', 'SpAudioFormat', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SOTMatchesAttributes', 'SREHypothesis', 'SPEVENTENUM',
    'eLEXTYPE_PRIVATE10', 'SAFT22kHz16BitStereo', 'SPAO_NONE',
    'SASClosed', 'DISPID_SRCRequestedUIType',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SVGetAudioInputs', 'SFTSREngine', 'SREBookmark',
    'DISPID_SPRules_NewEnum', 'SECNormalConfidence',
    'SPAUDIOBUFFERINFO', 'Speech_StreamPos_RealTime', 'SVP_3',
    'SGDSActiveWithAutoPause', 'SAFT8kHz8BitStereo',
    'SpeechAudioProperties', 'DISPID_SPEActualConfidence',
    'DISPID_SPPEngineConfidence', 'ISpPhoneticAlphabetSelection',
    'DISPID_SLWPronunciations', 'SREStreamEnd', 'DISPIDSPTSI',
    'SVSFNLPMask', 'SVSFPurgeBeforeSpeak', 'SVF_Emphasis',
    'SSSPTRelativeToEnd', 'SpeechAudioFormatType', 'SVEViseme',
    'SWPUnknownWordPronounceable', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SRCEFalseRecognition', 'SpeechEngineProperties',
    'DISPID_SOTGetDescription', 'SpeechVoiceEvents',
    'SSSPTRelativeToCurrentPosition', 'ISpeechPhraseInfo',
    'DISPID_SVEPhoneme', 'DISPID_SRGetPropertyNumber',
    'eLEXTYPE_RESERVED4', 'SPWT_LEXICAL', 'DISPID_SpeechLexiconProns',
    'DISPID_SVSCurrentStreamNumber', 'SBONone',
    'ISpeechXMLRecoResult', 'SGRSTTDictation', 'SAFTDefault',
    'DISPID_SVSInputSentencePosition', 'SPRECOGNIZERSTATUS',
    'DISPID_SOTCategory', 'SPEI_RESERVED5',
    'DISPID_SRGCmdSetRuleIdState', 'SAFTADPCM_22kHzMono',
    'DISPID_SpeechPhoneConverter', 'DISPID_SVGetAudioOutputs',
    'DISPID_SPPChildren', 'SAFTADPCM_8kHzStereo'
]

_check_version('1.1.14', 1658701842.566086)
